const testimonials = [
  ...
  {
    text: 'Hum log Nikah ke liye simple aur elegant invite chahte the. Pearl Nikah template bilkul waise hi tha — <em>no flashy colors, just pure grace.</em> Ammi ne kaha yeh printed card se bhi zyada izzatdaar lagta hai.',
    name: "Aisha & Zayan Ahmed",
    location: "Hyderabad · Pearl Nikah template · Mar 2025",
    initials: "AZ",
  ...
  {
    text: 'Sabse badi tension thi — 500 guests ko invite kaise kare. <em>₹1,999 mein unlimited RSVPs</em>, sab family groups mein share kiya, aur 3 din mein 400 se zyada RSVPs aa gaye. Paise bhi bache, time bhi.',
    name: "Riya & Aarav Patel",
    location: "Ahmedabad · Saffron Fest template · Feb 2025",
    initials: "RP",
    gradient: "linear-gradient(135deg,#5C2A1A,#8C4A2A)",
    platform: "Google",
    featured: false,
  },
];
    ...
    <div className="relative z-[1] max-w-[1160px] mx-auto">
      <div className="text-center mb-16">
        ...
        <div className="flex items-center justify-center gap-5 mt-6 flex-wrap">
          ...
          <span className="text-[13px] text-white/45 font-light"><strong className="text-white/75 font-medium">4.9 / 5</strong> average rating</span>
          <div className="w-[3px] h-[3px] rounded-full bg-secondary/40" />
          <span className="text-[13px] text-white/45 font-light"><strong className="text-white/75 font-medium">50,000+</strong> weddings</span>
          <div className="w-[3px] h-[3px] rounded-full bg-secondary/40" />
          <span className="text-[13px] text-white/45 font-light"><strong className="text-white/75 font-medium">India's #1</strong> digital invite platform</span>
        </div>
      </div>
