    ...
    <section className="py-16 px-6 bg-card">
      <div className="max-w-lg mx-auto">
        ...
        <div className="space-y-6">
          {enabled.map((event, index) => (
            <AnimateIn key={event.event_type} delay={index * 0.1}>
              <div className="border border-secondary/20 bg-background p-6 relative overflow-hidden">
