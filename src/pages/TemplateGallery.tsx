...
const TemplateCard = ({
  ...
  const videoSrc = ({"royal-maroon": "/videos/royal-maroon-preview.mov", "teal-luxury": "/videos/marigold-mandap.mp4", "golden-sehra": "/videos/golden-sehra.mp4?v=2", "emerald-south": "/videos/emerald-south.mp4?v=2"} as Record<string, string>)[t.id];
